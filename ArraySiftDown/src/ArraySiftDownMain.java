...
public final class ArraySiftDownMain {
    ...
    private static void siftDown(int[] array, int top, int last) {
        ...
        if (rightNodeIndex <= last) {
            int currentNode = array[top];
            int leftNode = array[leftNodeIndex];
            ...
            int rightNode = array[rightNodeIndex];
            ...
            siftDown(array, leftNodeIndex, last);
            siftDown(array, rightNodeIndex, last);
