...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        // initial first smart node.
        Node firstSmartNode = new Node();
        firstSmartNode.previous = null;

        this.preStart = firstSmartNode;
        this.lastLeft = firstSmartNode;

        // initial last smart node.
        Node lastSmartNode = new Node();
        lastSmartNode.next = null;
        this.postFinish = lastSmartNode;

        // connection first smart node and last smart node.
        firstSmartNode.next = lastSmartNode;
        lastSmartNode.previous = firstSmartNode;
    ...
    public final void addRightFront(T x) {
        ...
        Node oldFirstRightNode = this.lastLeft.next;

        // place new insert node into the in front of old one.
        node.next = oldFirstRightNode;
        oldFirstRightNode.previous = node;

        // point first smart node with the new insert node.
    ...
    public final T removeRightFront() {
        ...
        Node newFirstRightNode = removeNode.next;

        // remove first right node: push second right node into first.
        this.lastLeft.next = newFirstRightNode;
        newFirstRightNode.previous = this.lastLeft;
    ...
    public final void advance() {
        ...
        // move lastLeft to the next right node.
        Node firstRightNode = this.lastLeft.next;
        this.lastLeft = firstRightNode;
    ...
    public final void moveToStart() {
        ...
        // move lastLeft into very beginning.
    ...
    public final void retreat() {
        ...
        // move lastLeft to previous node.
        Node secondLastLeftNode = this.lastLeft.previous;
        this.lastLeft = secondLastLeftNode;
