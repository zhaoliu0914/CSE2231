...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final void multiplyBy10(int k) {
        ...
        if (!this.rep.equals("") || k != 0) {
            String lastDigit = Integer.toString(k);
            this.rep = this.rep + lastDigit;
        }
    }
    ...
    public final int divideBy10() {
        int lastDigit = 0;
        if (!this.rep.equals("")) {
            String lastDigitStr = this.rep.substring(this.rep.length() - 1);
            lastDigit = Integer.parseInt(lastDigitStr);
