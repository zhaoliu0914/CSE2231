...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_EMPTY = "data/program-sample-empty.bl";
    ...
    public final void testEmptyName() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_EMPTY);
        Program pRef = this.createFromFileRef(FILE_NAME_EMPTY);
    ...
    /**
     * Test swapContext. Test for empty context after swap.
     */
    @Test
    public final void testSwapContext_1() {
        /*
         * Setup
         */
        ...
        pRef.swapContext(contextRef);
        contextRef.removeAny();
        pRef.swapContext(contextRef);

        pTest.swapContext(contextTest);
        contextTest.removeAny();
    ...
    /**
     * Test swapBody. Test for empty body after swap.
     */
    @Test
    public final void testSwapBody_1() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        ...
        pRef.swapBody(bodyRef);
        bodyRef.removeFromBlock(0);
        pRef.swapBody(bodyRef);

        pTest.swapBody(bodyTest);
        bodyTest.removeFromBlock(0);
    ...
    /**
     * Test swapBody. Test for move last block to the first block.
     */
    @Test
    public final void testSwapBody_2() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        ...
        pRef.swapBody(bodyRef);
        int sizeRef = bodyRef.lengthOfBlock();
        Statement lastRef = bodyRef.removeFromBlock(sizeRef - 1);
        /* bodyRef now does not have the last statement */
        pRef.swapBody(bodyRef);
        /* pRef's body does not have the last statement */
        bodyRef.addToBlock(0, lastRef);
        /* bodyRef now adds the last statement to the first statement */

        /* Make the reference call, replacing, in pRef, remaining with first: */
        pRef.swapBody(bodyRef);

        pTest.swapBody(bodyTest);
        int sizeTest = bodyTest.lengthOfBlock();
        Statement lastTest = bodyTest.removeFromBlock(sizeTest - 1);
        /* bodyTest now does not have the last statement */
        pTest.swapBody(bodyTest);
        /* pTest's body now does not have the last statement */
        bodyTest.addToBlock(0, lastTest);
        /* bodyTest now adds the last statement to the first statement */
