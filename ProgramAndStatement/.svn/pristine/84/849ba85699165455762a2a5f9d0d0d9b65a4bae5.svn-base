...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_IF = "data/statement-sample-if.bl";
    private static final String FILE_NAME_IFELSE = "data/statement-sample-ifelse.bl";
    private static final String FILE_NAME_WHILE = "data/statement-sample-while.bl";
    private static final String FILE_NAME_CALL = "data/statement-sample-call.bl";
    private static final String FILE_NAME_EMPTY = "data/statement-sample-empty.bl";
    ...
    /**
     * Test addToBlock to the last position.
     */
    @Test
    public final void testAddToEmptyBlock() {
        ...
        int size = sRef.lengthOfBlock();

        sRef.addToBlock(size - 1, nestedRef);

        /*
         * The call
         */
        sTest.addToBlock(size - 1, nestedTest);
    ...
    /**
     * Test lengthOfBlock, equals to zero.
     */
    @Test
    ...
    /**
     * Test disassembleIf. It would be empty after disassembleIf
     */
    @Test
    public final void testDisassembleIf_empty() {
        /*
         * Setup
         */
    ...
    /**
     * Test disassembleIfElse. It would be empty after disassembleIfElse
     */
    @Test
    public final void testDisassembleIfElse_empty() {
        /*
         * Setup
         */
        Statement blockRef = this.createFromFileRef(FILE_NAME_IFELSE);
        Statement blockTest = this.createFromFileTest(FILE_NAME_IFELSE);

        Statement sRef = blockRef.removeFromBlock(0);
        Statement sTest = blockTest.removeFromBlock(0);

        Statement trueRef = sRef.newInstance();
        Statement falseRef = sRef.newInstance();
        Statement trueTest = sTest.newInstance();
        Statement falseTest = sTest.newInstance();

        Condition cRef = sRef.disassembleIfElse(trueRef, falseRef);

        /*
         * The call
         */
        Condition cTest = sTest.disassembleIfElse(trueTest, falseTest);

        /*
         * Evaluation
         */
        assertEquals(trueRef, trueTest);
        assertEquals(falseRef, falseTest);
        assertEquals(sRef, sTest);
        assertEquals(cRef, cTest);
    }

    /**
     * Test disassembleWhile. It would be empty after disassembleWhile
     */
    @Test
    public final void testDisassembleWhile_empty() {
        /*
         * Setup
         */
    ...
    /**
     * Test disassembleCall. It would be empty after disassembleCall
     */
    @Test
    public final void testDisassembleCall_empty() {
        /*
         * Setup
         */
        ...
        String cRef = sRef.disassembleCall();

        /*
         * The call
         */
        String cTest = sTest.disassembleCall();
